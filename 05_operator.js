...
function performStringCalculations() {
    ...
    console.log("Multiplication of string length and total words:", multipliedLength);
}
...
console.log("Square of 'Developer Smart' length:", squareOfWordLength("Developer Smart"));
